const projects_bcs = [
  ...
  {
    id: 2,
    title: "Migrating a Site to Bootstrap",
    logo: "bcs-logo.png",
    tech: ["Bootstrap 5", "Grid System", "Components", "Utility Classes"],
    techIcons: ["bootstrap.png", "grid.png", "components.png", "utilities.png"],
    description: "Full Bootstrap integration with responsive design, utility classes, and interactive components.",
    link: "https://tnguyenlp1.github.io/3.-Migrating-a-Site-to-Bootstrap-BCS-Lv4-Bootcamp/"
  },
  {
    id: 3,
  ...
  },
  {
    ...
    tech: ["Python", "CLI", "Markdown", "PyInquirer"],
    techIcons: ["python.png", "cli.png", "markdown.png", "pyinquirer.png"],
    description: "Command-line app to generate fully formatted GitHub README.md files with user input prompts.",
    link: "https://github.com/TNguyenLP1/6.-GitHub-README.md-Generator-BCS-Lv4-Bootcamp"
  },
  {
    id: 6,
    title: "Full Stack Notes Application",
    logo: "node-logo.png",
    tech: ["Node.js", "Express.js", "MongoDB", "CRUD Operations", "Deployment"],
    techIcons: ["node.png", "express.png", "mongodb.png", "crud.png", "render.png"],
    description: "Full-stack note-taking app with persistent storage, CRUD operations, and deployed on Render.",
    link: "https://seven-fullstack-notes-application-using.onrender.com"
  },
  {
    id: 7,
    title: "Tech Blog Application",
    logo: "node-logo.png",
    tech: ["Node.js", "Express.js", "MySQL", "Sequelize ORM", "Authentication"],
    techIcons: ["node.png", "express.png", "mysql.png", "sequelize.png", "auth.png"],
    description: "Full-stack blog app with secure login, CRUD posts, category filters, and dynamic rendering.",
    link: "https://eight-fullstack-tech-blog-application.onrender.com/"
  },
  {
    id: 8,
    ...
    link: "https://nine-react-portfolio-bcs-lv4-bootcamp-1.onrender.com"
  },
  {
    id: 9,
